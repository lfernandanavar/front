  ...
  const sections = [
    {
      ...
      icon: <Plane className="w-16 h-16 text-white p-3 bg-indigo-500 rounded-full" />,
      route: "/admin/vuelosa"
    },
    {
      title: "Usuarios",
      description: "Administración de clientes y staff",
      icon: <Users className="w-16 h-16 text-white p-3 bg-green-500 rounded-full" />,
      route: "/admin/usuarios"
    },
    {
      title: "Nómina",
      description: "Control de pagos y empleados",
      icon: <Wallet className="w-16 h-16 text-white p-3 bg-yellow-500 rounded-full" />,
      route: "/admin/nomina"
    },
    {
      title: "Status del vuelo",
      description: "Seguimiento en tiempo real",
      icon: <ActivitySquare className="w-16 h-16 text-white p-3 bg-teal-500 rounded-full" />,
      route: "/admin/status"
    },
    {
      title: "Reportes",
      description: "Informes administrativos",
      icon: <FileText className="w-16 h-16 text-white p-3 bg-gray-600 rounded-full" />,
      route: "/admin/reportes"
    },
    {
      title: "Gráficas",
      description: "Análisis visual de datos",
      icon: <BarChart className="w-16 h-16 text-white p-3 bg-purple-500 rounded-full" />,
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <main className="container mx-auto px-6 py-16">
        <h2 className="text-4xl font-extrabold mb-10 text-center text-gray-800">Panel de Control</h2>
